...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAprendizApi>();
            ApiAprendizGetApiResponse apiResponse = await api.ApiAprendizGetAsync("todo");
            List<AprendizDto> model = apiResponse.Ok();
        }
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {2478D61D-3198-4058-8D72-DCAAB7009FAF}
- packageName: Org.OpenAPITools
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
